...
class MacroCommand(frameworck.patterns.observer.Notifier, frameworck.interfaces.ICommand,frameworck.interfaces.INotifier):
    """
...
class SimpleCommand(frameworck.patterns.observer.Notifier,frameworck.interfaces.ICommand, frameworck.interfaces.INotifier):
    """
