...
import frameworck.core
import frameworck.interfaces
import frameworck.patterns.observer

class Facade(frameworck.interfaces.IFacade):
    """
    ...
    def initializeController(self):
        ...
        if (self.controller is not None):
            return
        self.controller = frameworck.core.Controller.getInstance()
    ...
    def initializeModel(self):
        ...
        if (self.model is not None):
            return
        self.model = frameworck.core.Model.getInstance()
    ...
    def initializeView(self):
        ...
        if (self.view is not None):
            return
        self.view = frameworck.core.View.getInstance()
    ...
    def sendNotification(self, notificationName, body=None, type=None):
        ...
        """
        self.notifyObservers(frameworck.patterns.observer.Notification(notificationName, body, type))
