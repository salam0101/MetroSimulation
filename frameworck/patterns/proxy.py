...
import frameworck.patterns.observer
import frameworck.patterns.facade

class Proxy(frameworck.patterns.observer.Notifier, frameworck.interfaces.IProxy, frameworck.interfaces.INotifier):
    """
    A base C{IProxy} implementation. 
    
    In frameworck, C{Proxy} classes are used to manage parts of the 
    ...
    @see: L{Model<org.frameworck.as3.core.model.Model>}
    """
